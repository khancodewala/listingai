              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                <tr>
                  <td style="background:${accentColor};border-radius:8px;">
                    <a href="https://www.joinlistingai.com/generate" style="display:inline-block;padding:14px 32px;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px;">
                      Start Generating →
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
                <tr>
                  <td style="background:${accentColor};border-radius:8px;">
                    <a href="https://www.joinlistingai.com/dashboard" style="display:inline-block;padding:14px 32px;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px;">
                      Manage Billing →
                    </a>
                  </td>
                </tr>
